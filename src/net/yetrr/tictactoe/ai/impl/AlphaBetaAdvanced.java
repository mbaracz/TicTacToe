...
public class AlphaBetaAdvanced implements Algorithm {

    private final double depth;

    private final State player;

    public AlphaBetaAdvanced(State player, double depth) {
        if (depth < 1) {
    ...
    private int score(State player, Board board, int currentDepth) {
